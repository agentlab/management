...
public class VersionRangeGreaterThanOpen_contains_Test {
	...
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            { new VersionRangeGreaterThanOpen(v1_0_0), v0_0_0,    false },
            { new VersionRangeGreaterThanOpen(v1_0_0), v1_0_0,    false }, // bound
            { new VersionRangeGreaterThanOpen(v1_0_0), v1_0_1,    true  },
            { new VersionRangeGreaterThanOpen(v1_0_0), v1_1_0,    true  },
            { new VersionRangeGreaterThanOpen(v1_0_0), v1_1_1,    true  },
            { new VersionRangeGreaterThanOpen(v1_0_0), v2_0_0,    true  },
            { new VersionRangeGreaterThanOpen(v1_0_0), v1000_0_0, true  },
            // Greater Than Open Zeros (0.0.0, )                  
            { new VersionRangeGreaterThanOpen(v0_0_0), v0_0_0,    false }, // bound
            { new VersionRangeGreaterThanOpen(v0_0_0), v0_0_1,    true  },
            { new VersionRangeGreaterThanOpen(v0_0_0), v0_1_0,    true  },
            { new VersionRangeGreaterThanOpen(v0_0_0), v1_0_0,    true  },
        	// @formatter:on
		});
	}
