...
public class VersionRangeFactory_closedOpen_Test {

	@Parameters(name = "{index}: closed-open from {0} and {1} is {2}")
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            //                                                                                                                                                      
            { v1_0_0,        v1_0_1,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanOpen(v1_0_1))              },
            { v1_0_0,        v1_1_0,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanOpen(v1_1_0))              },
            { v1_0_0,        v2_0_0,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanOpen(v2_0_0))              },
            { v1_0_1_alpha,  v1_0_1_alpha1, new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_1_alpha),new VersionRangeLessThanOpen(v1_0_1_alpha1)) },
        	// @formatter:on
		});
	}
	...
	public void evaluate() {
		...
		// When
		VersionRange actual = VersionRangeFactory.closedOpen(first, second);
		// Then
