...
public class VersionRangeGreaterThanClosed_contains_Test {
	...
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            { new VersionRangeGreaterThanClosed(v1_0_0), v0_0_0,    false },
            { new VersionRangeGreaterThanClosed(v1_0_0), v1_0_0,    true  }, // bound
            { new VersionRangeGreaterThanClosed(v1_0_0), v1_0_1,    true  },
            { new VersionRangeGreaterThanClosed(v1_0_0), v1_1_0,    true  },
            { new VersionRangeGreaterThanClosed(v1_0_0), v1_1_1,    true  },
            { new VersionRangeGreaterThanClosed(v1_0_0), v2_0_0,    true  },
            { new VersionRangeGreaterThanClosed(v1_0_0), v1000_0_0, true  },
            // Greater Than Closed Zeros [0.0.0,)                   
            { new VersionRangeGreaterThanClosed(v0_0_0), v0_0_0,    true  }, // bound
            { new VersionRangeGreaterThanClosed(v0_0_0), v0_0_1,    true  },
            { new VersionRangeGreaterThanClosed(v0_0_0), v0_1_0,    true  },
            { new VersionRangeGreaterThanClosed(v0_0_0), v1_0_0,    true  },
        	// @formatter:on
		});
	}
