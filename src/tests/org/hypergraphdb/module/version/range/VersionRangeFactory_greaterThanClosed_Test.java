...
public class VersionRangeFactory_greaterThanClosed_Test {

	@Parameters(name = "{index}: greaterThanClosed from {0} is {1}")
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            //                                                                                      
            { v0_0_0,        new VersionRangeGreaterThanClosed(v0_0_0)                            },
            { v1_0_0,        new VersionRangeGreaterThanClosed(v1_0_0)                            },
            { v1_0_1,        new VersionRangeGreaterThanClosed(v1_0_1)                            },
            { v1_1_0,        new VersionRangeGreaterThanClosed(v1_1_0)                            },
            { v2_0_0,        new VersionRangeGreaterThanClosed(v2_0_0)                            },
            { v1_0_1_alpha,  new VersionRangeGreaterThanClosed(v1_0_1_alpha)                      },
        	// @formatter:on                                                                      
		});
	}
	...
	public void evaluate() {
		...
		// When
		VersionRange actual = VersionRangeFactory.greaterThanClosed(first);
		// Then
