...
public class VersionRangeFactory_greaterThanOpen_Test {

	@Parameters(name = "{index}: greaterThanOpen from {0} is {1}")
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            //                                                                                      
            { v0_0_0,        new VersionRangeGreaterThanOpen(v0_0_0)                              },
            { v1_0_0,        new VersionRangeGreaterThanOpen(v1_0_0)                              },
            { v1_0_1,        new VersionRangeGreaterThanOpen(v1_0_1)                              },
            { v1_1_0,        new VersionRangeGreaterThanOpen(v1_1_0)                              },
            { v2_0_0,        new VersionRangeGreaterThanOpen(v2_0_0)                              },
            { v1_0_1_alpha,  new VersionRangeGreaterThanOpen(v1_0_1_alpha)                        },
        	// @formatter:on                                                                      
		});
	}
	...
	public void evaluate() {
		...
		// When
		VersionRange actual = VersionRangeFactory.greaterThanOpen(first);
		// Then
