...
public class VersionRangeLessThanClosed_contains_Test {
	...
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            { new VersionRangeLessThanClosed(v1_0_0), v0_0_0,    true  },
            { new VersionRangeLessThanClosed(v1_0_0), v0_0_1,    true  },
            { new VersionRangeLessThanClosed(v1_0_0), v0_1_0,    true  },
            { new VersionRangeLessThanClosed(v1_0_0), v0_1_1,    true  },
            { new VersionRangeLessThanClosed(v1_0_0), v1_0_0,    true  }, // bound
            { new VersionRangeLessThanClosed(v1_0_0), v1_0_1,    false },
            { new VersionRangeLessThanClosed(v1_0_0), v1_1_0,    false },
            { new VersionRangeLessThanClosed(v1_0_0), v1_1_1,    false },
            { new VersionRangeLessThanClosed(v1_0_0), v2_0_0,    false },
            { new VersionRangeLessThanClosed(v1_0_0), v1000_0_0, false },
        	// @formatter:on
		});
	}
