...
public class VersionRangeFactory_lessThanOpen_Test {

	@Parameters(name = "{index}: lessThanOpen from {0} is {1}")
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            //                                                                                      
            { v0_0_0,        new VersionRangeLessThanOpen(v0_0_0)                                 },
            { v1_0_0,        new VersionRangeLessThanOpen(v1_0_0)                                 },
            { v1_0_1,        new VersionRangeLessThanOpen(v1_0_1)                                 },
            { v1_1_0,        new VersionRangeLessThanOpen(v1_1_0)                                 },
            { v2_0_0,        new VersionRangeLessThanOpen(v2_0_0)                                 },
            { v1_0_1_alpha,  new VersionRangeLessThanOpen(v1_0_1_alpha)                           },
        	// @formatter:on                                                                      
		});
	}
	...
	public void evaluate() {
		...
		// When
		VersionRange actual = VersionRangeFactory.lessThanOpen(first);
		// Then
