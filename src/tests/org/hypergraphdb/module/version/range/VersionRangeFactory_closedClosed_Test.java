...
public class VersionRangeFactory_closedClosed_Test {

	@Parameters(name = "{index}: closed-closed from {0} and {1} is {2}")
	public static Collection<Object[]> parameters() {
		return Arrays.asList(new Object[][] {
            ...
            // Equal to single                                                                                                                                            
            { v0_0_0,        v0_0_0,        single(v0_0_0)                                                                                                              },
            { v0_0_0$1,      v0_0_0$2,      single(v0_0_0$1)                                                                                                            },
            { v1_0_0,        v1_0_0,        single(v1_0_0)                                                                                                              },
            { v1000_0_0,     v1000_0_0,     single(v1000_0_0)                                                                                                           },
            //                                                                                                                                                      
            { v1_0_0,        v1_0_1,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanClosed(v1_0_1))              },
            { v1_0_0,        v1_1_0,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanClosed(v1_1_0))              },
            { v1_0_0,        v2_0_0,        new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_0),new VersionRangeLessThanClosed(v2_0_0))              },
            { v1_0_1_alpha,  v1_0_1_alpha1, new VersionRangeIntersection(new VersionRangeGreaterThanClosed(v1_0_1_alpha),new VersionRangeLessThanClosed(v1_0_1_alpha1)) },
        	// @formatter:on
		});
	}
	...
	public void evaluate() {
		...
		// When
		VersionRange actual = VersionRangeFactory.closedClosed(first, second);
		// Then
